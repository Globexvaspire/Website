    ...
    return (
        <div id="products" className="container m-auto h-full flex justify-center">
            <div className="w-full">
                <h1 className="w-full title text-xl lg:text-4xl mb-5 text-center bg-gradient-to-r from-color1 via-color2 via-color3 to-color4 p-6 text-black shadow-xl">Products</h1>
