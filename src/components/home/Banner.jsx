...
const Banner = () => {
    return (
        <div id="home" className="container h-[100vh] m-auto flex justify-center items-center">
            <div className="flex flex-col items-center justify-center bg-gradient-to-r from-color1 via-color2 via-color3 to-color4 opacity-80 w-full py-6 lg:p-20 shadow-2xl border-b-2 lg:border-t-0 lg:border-l-2 border-b-2 border-black">
