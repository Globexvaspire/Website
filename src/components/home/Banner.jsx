...
const Banner = () => {
    return (
        <div id="home" className="container h-[100vh] m-auto flex justify-center items-center">
            <div className="text-black flex flex-col items-center justify-center bg-gradient-to-r from-color1 via-color2 via-color3 to-color4 opacity-80 w-full py-6 lg:p-20 shadow-2xl border-b-2 lg:border-t-0 lg:border-l border-b border-black">
                <h1 className="text-6xl text-center lg:text-7xl xl:text-9xl leading-none tracking-wide title font-medium">Your path<br/>to<br/>Virtual Assistant</h1>
                <div className="py-5 w-[90%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%] detail text-center font-normal text-sm md:text-base lg:text-lg">
