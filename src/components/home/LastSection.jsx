    ...
    return (
        <div className="container m-auto flex justify-center">
            <div id="about" className="w-full flex justify-center flex-col-reverse md:flex-row items-center">
                <div className="pb-10 md:w-[60%] w-full flex justify-center items-center flex-col px-2 mt-2 md:mt-0 py-2 2xl:border-t-2 2xl:border-r-2 border-color1">
                    <h1 className="text-color1 font-title text-6xl md:text-7xl lg:text-8xl my-5 lg:mb-10 text-center">Empower your future</h1>
