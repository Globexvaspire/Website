        ...
        <div className="w-full">
            <div className="container m-auto">
                <div className="flex justify-center items-center flex-col pb-10">
                    ...
                    <Accordion open={open === 2} className="border-b border-gray opacity-70 hover:opacity-100">
                    ...
                    <Accordion open={open === 3} className="border-b border-gray opacity-70 hover:opacity-100">
                    ...
                    <Accordion open={open === 4} className="border-b border-gray opacity-70 hover:opacity-100">
                    ...
                    <Accordion open={open === 5} className="border-b border-gray opacity-70 hover:opacity-100">
                    ...
                    <Accordion open={open === 6} className="border-b border-gray opacity-70 hover:opacity-100">
