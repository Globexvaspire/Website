            ...
            <div className="container m-auto">
                <div className="w-full flex justify-center flex-col md:flex-row p-2 py-20">
                    <div className="w-full md:w-[60%] pb-2 md:pb-0 flex flex-col items-center">
                        <h1 className="text-black title text-4xl md:text-6xl font-semibold w-full xl:w-[60%] text-center">Frequently Asked Questions</h1>
                        <p className="text-black detail text-md md:text-base lg:text-lg p-4 text-center w-full md:w-[60%]">Here&apos;s the answers for these frequently asked questions.</p>
                    </div>
                    ...
                    <Accordion open={open === 1} className="border-b border-black opacity-70 hover:opacity-100">
                        ...
                        <AccordionBody className="detail text-md lg:text-lg xl:text-xl">
