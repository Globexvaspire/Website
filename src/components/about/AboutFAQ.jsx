            ...
            <div className="container m-auto">
                <div className="w-full flex justify-center flex-col md:flex-row p-2 py-20">
                    <div className="w-full md:w-[60%] pb-2 md:pb-0 flex flex-col items-center">
                        ...
                        <p className="font-detail text-md md:text-base lg:text-lg p-4 text-center w-full md:w-[60%]">Here&apos;s the answers for these frequently asked questions.</p>
                    </div>
                    ...
                    <Accordion open={open === 7} className="border-b-2 border-black opacity-70 hover:opacity-100">
