        ...
        <div className="w-full">
            <div className="container m-auto">
                <div className="text-black text-center flex items-center flex-col py-6">
                    ...
                    <p className="detail text-md lg:text-lg xl:text-xl p-4 pt-8 w-full xl:w-[60%]">Ever wondered how Filipinos are thriving as Virtual Assistants? Seen those inspiring posts about flexible work and thought, 'I want that life too'? Well, you&apos;re in the right place! This eBook is your ultimate guide to starting your career as a Virtual Assistant, equipping you with the skills and strategies to succeed.</p>
