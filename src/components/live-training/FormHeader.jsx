...
const FormHeader = () => {
    return (
         <div className="bg-neutral w-full p-4 flex text-white flex justify-between items-center">
                                            <a href="/" className="w-full text-center w-fit hover:text-black lg:text-2xl flex justify-center md:w-[33%]">
                                                <IoMdHome className="text-3xl md:text-4xl"/>
                                            </a>
                                                <div className="flex gap-4 text-white sm:justify-center md:w-[33%]">
                                                <Typography as="a" target="_blank" href="https://www.facebook.com/profile.php?id=61571249031373" className="hover:text-black">
                                                    <FaFacebook className="w-8 h-8"/>
                                                </Typography>
                                                <Typography as="a" target="_blank" href="https://www.instagram.com/globexvaspire/profilecard/?igsh=MWlhYjZyYnlteHhwaA%3D%3D&fbclid=IwY2xjawHwl0xleHRuA2FlbQIxMAABHSyG6JeX41dU49Xhz2IMQwb4VuaKv8qzsuMzIh0Z5BGk0emmzbBkRcwzYw_aem_AnpF6jvCcYJE7PgsbFWxRw" className="hover:text-black">
