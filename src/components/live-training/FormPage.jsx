        ...
        <div className="w-full">
            <div className="container m-auto">
                <div className="w-full p-4 md:p-10">
                    ...
                    <div className="font-detail text-black pt-5">
                            ...
                            <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                                ...
                                <button onClick={handleSubmit} className="py-2 w-[50%] bg-black text-center text-white border-2 border-white shadow-2xl font-detail text-md md:text-lg transition-all hover:scale-105">Enroll Now</button>
                                </div>
                            </form>
                    </div>
                </div>
