...
const AboutPage = () => {
    return (
      ...
      <main>
        <section id="section-1" className="w-full min-h-[100vh] bg-gradient-to-r from-color1 via-color2 to-color3 flex items-center">
          <AboutBanner/>
        </section>
        <div className="w-full">
          <h1 className="bg-lightMatcha p-6 lg:p-10 text-white font-title text-2xl lg:text-4xl text-center shadow-2xl">&quot;Greatness begins with the courage to start something new&quot;</h1>
        </div>
        <section id="section-2" className="w-full bg-white">
          <AboutWelcome/>
        </section>
        <div className="w-full">
          <h1 className="bg-lightMatcha p-6 lg:p-10 text-white font-title text-2xl lg:text-4xl text-center shadow-2xl">Enroll Now and start earning!</h1>
        </div>
        ...
        <div className="w-full">
          <h1 className="bg-lightMatcha p-6 lg:p-10 text-white font-title text-2xl lg:text-4xl text-center shadow-2xl">What people say about me and my products?</h1>
        </div>
        ...
        <div className="w-full bg-lightMatcha shadow-2xl flex justify-center p-4 lg:p-8">
