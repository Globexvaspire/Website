...
const LINKS = [
    {
      title: "Product",
      items: [
        {heading: "Client Onboarding and Success Kit", link: "https://www.raket.ph/globexvaspire/products/client-onboarding-and-success-kit"}, 
